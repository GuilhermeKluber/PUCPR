...
class Generation:
    def __init__(self):
        ...
        self.finput = open('input.csv', 'a+')
        self.foutput = open('output.csv', 'a+')
        self.outputwriter = csv.writer(self.finput, delimiter=',')
        self.inputwriter = csv.writer(self.foutput, delimiter=',')
        self.finput.flush()
